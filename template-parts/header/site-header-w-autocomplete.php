...
<input type="search" id="coursesearch" class="coursesearchfield" name="s" required>
...
const txtbox = document.getElementById('coursesearch');
// txtbox.onfocus = function(e) {
//   document.getElementById('searchbar').style.height = '400px';
// }
txtbox.onkeyup = function(e) {
    let searchfield = txtbox.value;

    if(searchfield === '' || searchfield.length < 3)  {
      document.getElementById('courseresults').innerHTML = '';
      document.getElementById('searchbar').style.height = '75px';
      return;
    }
    if(searchfield.length > 2)  {
        document.getElementById('searchbar').style.height = 'auto';
        let regex = new RegExp(searchfield, "i");
        let output = '<div class="coursebox">';
